;(function($){
    ...
    $(".edit-address-btn").click(function(){
        $('.edit_address_box').css('display','none');
        $('.edit_address_btn').css('display','block');
    });
    ...
    $('.add_new_child_cancel_btn').click(function(){
        $('.add_new_child_box').css('display','none');
        $('.add_new_child_btn').css('display','block');
    });
    ...
    $(".edit_child_cancel_btn").click(function(){
        $('.edit_child_box').css('display','none');
        $('.edit_child_btn').css('display','block');
    });
